document.addEventListener('userConsentReady', function (detail) {
    ...
    console.log("MP-OPS: User Consent Ready Event Fired")
}, true)
...
document.addEventListener('AdFuelCreated', function (detail) {
    ...
    console.log("MP-OPS: AdFuel is Created Event Fired")
...
document.addEventListener('AdFuelRequestComplete', function (detail) {
    ...
    console.log("MP-OPS: AdFuel Request Complete Event Fired")
}, true)
...
document.addEventListener('GPTRenderComplete', function (event) {
    ...
    console.log('MP-OPS: GPTRenderComplete Event for ' + event.detail.divId + ' fired');
}, true)
...
document.addEventListener('GPTSlotLoaded', function (event) {
    ...
    console.log('MP-OPS: GPTSlotLoaded Event for ' + event.detail.slot.getSlotElementId() + ' fired');
}, true)
